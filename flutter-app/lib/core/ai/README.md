...
lib/core/ai/
├── models/               # Data models
│   ├── ai_task.dart     # Task types, compai_tutorty, learner levels
...
**Architecture Phases:**
1. **Task Analysis** - Detect task type, compai_tutorty, learner level
...
```dart
import 'package:ai_tutor_app/core/ai/orchestrator/ai_orchestrator.dart';
import 'package:ai_tutor_app/core/ai/context/context_manager.dart';
import 'package:ai_tutor_app/core/ai/stt/stt_service.dart';
import 'package:ai_tutor_app/core/ai/tts/tts_service.dart';
import 'package:ai_tutor_app/core/ai/pronunciation/pronunciation_service.dart';
...
User Text
    ↓
Task Analysis → Determine tasks, compai_tutorty, learner level
    ↓
